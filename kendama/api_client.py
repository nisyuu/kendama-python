...
from kendama.api_response import ApiResponse, T as ApiResponseT
import kendama.models
from kendama import rest
from kendama.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(kendama.models, klass)
